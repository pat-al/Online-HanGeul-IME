...
additional_layouts.push({KE: 'Ko', type_name: '3m-Moa2014', full_name: '모아치기 2014', layout: K3_Moachigi_2014_layout, sublayout: K3_Moachigi_2014_sublayout, hangeul_combination_table: K3_Moachigi_2014_combination_table});
additional_layouts.push({KE: 'Ko', type_name: '3-Moa2014', full_name: '모아치기 2014 (이어치기 방식)', layout: K3_Moachigi_2014_layout, sublayout: K3_Moachigi_2014_sublayout, hangeul_combination_table: K3_Moachigi_2014_combination_table});
additional_layouts.push({KE: 'Ko', type_name: '3m-Moa2015', full_name: '모아치기 2015', layout: K3_Moachigi_2015_layout, sublayout: K3_Moachigi_2015_sublayout, multikey_combination_table: K3_Moachigi_2015_multikey_combination_table, moachigi_combination_table: K3_Moachigi_2015_combination_table, link: 'http://ssg.wo.tc/220239514856'});
additional_layouts.push({KE: 'Ko', type_name: '3-Moa2015', full_name: '모아치기 2015 (이어치기 방식)', layout: K3_Moachigi_2015_layout, sublayout: K3_Moachigi_2015_sublayout, hangeul_combination_table: K3_Moachigi_2015_combination_table, link: 'http://ssg.wo.tc/220239514856'});

additional_layouts.push({KE: 'Ko', type_name: '4t-Pyojun', full_name: '옛 표준 네벌식 타자기 (1969)', layout: K3_Pyojun_4beol_Typewriter_1969_layout, link: 'http://pat.im/965'});
additional_layouts.push({KE: 'Ko', type_name: '3t-Oesol', full_name: '외솔 타자기 (1981, 최동식·김광성)', layout: K3_Oesol_Typewriter_layout, hangeul_combination_table: K3_Oesol_Typewriter_combination_table, link: 'http://pat.im/1026'});
...
function additional_keyboard_layout_table_info() {
	...
	// 신세벌식 P (연구안 3) 겹낱자 확장 배열
	K3_Sin3_P_test3_sublayout = [
		0x0000,	/* 0x21 exclam: */
		0x0000,	/* 0x22 quotedbl: */
		0x0000,	/* 0x23 numbersign: */
		0x0000,	/* 0x24 dollar: */
	...
	// 신세벌식 P (연구안 4) 겹낱자 확장 배열
	K3_Sin3_P_test4_sublayout = [
		0x0000,	/* 0x21 exclam: */
		0x0000,	/* 0x22 quotedbl: */
		0x0000,	/* 0x23 numbersign: */
		0x0000,	/* 0x24 dollar: */
	...
	K3_Sin3_P_test5_layout = [
		...
		0x110e,	/* 0x6F o:            choseong chieuch */
		0x1111,	/* 0x70 p:            choseong pieup */
		0x11bb,	/* 0x71 q:            jongseong ssangsieus */
		0x11c0,	/* 0x72 r:            jongseong tieut */
		0x11ab,	/* 0x73 s:            jongseong nieun */
		0x11be,	/* 0x74 t:            jongseong chieuch */
		0x1103,	/* 0x75 u:            choseong dieud */
	...
	K3_Sin3_P_test6_layout = [
		...
		0x11c2,	/* 0x64 d:            jongseong hieuh */
		0x11bb,	/* 0x65 e:            jongseong ssangsieus */
		0x11c1,	/* 0x66 f:            jongseong pieup */
		0x11ae,	/* 0x67 g:            jongseong dieud */
		0x1102,	/* 0x68 h:            choseong nieun */
		0x1106,	/* 0x69 i:            choseong mieum */
	...
	// 신세벌식 P (연구안 6) 겹낱자 확장 배열
	K3_Sin3_P_test6_sublayout = [
		0x0000,	/* 0x21 exclam: */
		0x0000,	/* 0x22 quotedbl: */
		0x0000,	/* 0x23 numbersign: */
		0x0000,	/* 0x24 dollar: */
		...
		0x11aa,	/* 0x41 A: jongseong gieug-sieus */
		0x0000,	/* 0x42 B */
		0x11b2,	/* 0x43 C: jongseong lieul-bieub */
		0x11b6,	/* 0x44 D: jongseong lieul-hieuh */
		0x11b9,	/* 0x45 E: jongseong bieub-sieus */
		0x11B5,	/* 0x46 F: jongseong lieul-pieup */
		0x0000,	/* 0x47 G */
		0x0000,	/* 0x48 H */
		0x0000,	/* 0x49 I */
		...
		0x11aa,	/* 0x61 a; jongseong gieug-sieus */
		0x0000,	/* 0x62 b */
		0x11b2,	/* 0x63 c: jongseong lieul-bieub */
		0x11b6,	/* 0x64 d: jongseong lieul-hieuh */
		0x11b9,	/* 0x65 e: jongseong bieub-sieus */
		0x11b5,	/* 0x66 f: jongseong lieul-pieup */
		0x0000,	/* 0x67 g */
		0x0000,	/* 0x68 h */
		0x0000,	/* 0x69 i */
