...
additional_layouts.push({KE: 'Ko', type_name: '3-2014', full_name: '3-2014', layout: K3_2014_layout, extended_sign_layout: K3_2012y_extended_sign_layout, old_hangeul_layout_type_name: '3-2014-y', link: 'https://pat.im/1088'});
...
additional_layouts.push({KE: 'Ko', type_name: '3-2015M', full_name: '3-2015M', layout: K3_2015M_layout, hangeul_combination_table: K3_2015M_combination_table, link: 'http://cafe.daum.net/3bulsik/JMKX/46'});
additional_layouts.push({KE: 'Ko', type_name: '3-2015P', full_name: '3-2015P', layout: K3_2015P_layout, extended_sign_layout: K3_2012y_extended_sign_layout, old_hangeul_layout_type_name: '3-2015P-y', link: 'https://pat.im/1090'});
...
additional_layouts.push({KE: 'Ko', type_name: '3-P3', full_name: '3-P3', layout: K3_P3_layout, extended_sign_layout: K3_P3_extended_sign_layout, link: 'https://pat.im/1128'});
additional_layouts.push({KE: 'Ko', type_name: '3-P2', full_name: '3-P2', layout: K3_P2_layout, extended_sign_layout: K3_2012y_extended_sign_layout, link: 'https://pat.im/1128'});
...
additional_layouts.push({KE: 'Ko', type_name: 'Sin3-P-y', full_name: '신세벌식 P 옛한글 조합', layout: K3_Sin3_P_y_layout, capslock_layout: K3_Sin3_P_y_capslock_layout, extended_sign_layout: K3_Sin3_extended_sign_layout, capslock_extended_sign_layout: null, combination_table: K3_Sin3_P2_yeshangeul_combination_table, link: 'https://pat.im/1136#2-4'});
...
additional_layouts.push({KE: 'Ko', type_name: 'Sin3-Cham-f', full_name: '참신세벌식-f', layout: K3_Sin3_Cham_f_layout, link: 'https://doc9107.tistory.com/67?category=692391'});
...
function input_additional_keyboard_layout_info() {
	...
	K3_2014_layout = [
		...
		[0x1169,0x0000],	/* 0x2F slash: jungseong o */
		[0x110F,0x0000],	/* 0x30 0: choseong kieuk */
		[0x11C2,0x0000],	/* 0x31 1: jongseong hieuh */
		[0x11BB,0x0000],	/* 0x32 2: jongseong ssangsieus */
		...
		[0x116E,0x0000],	/* 0x39 9: jungseong u */
		...
		[0x1164,0x1164],	/* 0x54 T: jungseong yae, jungseong yae */
		...
		[0x11A9,0x11A9],	/* 0x58 X: jongseong ssanggieug, jongseong ssanggieug */
		...
		[0x116E,0x0000],	/* 0x62 b: jungseong u */
		[0x1166,0x11AA],	/* 0x63 c: jungseong e, jongseong gieug-sieus */  
		[0x1175,0x11B2],	/* 0x64 d: jungseong I, jongseong lieul-bieub */  
		[0x1167,0x11AC],	/* 0x65 e: jungseong yeo, jongseong nieun-jieuj */
		[0x1161,0x11B4],	/* 0x66 f: jungseong a, jongseong lieul-tieut */  
		[0x1173,0x0000],	/* 0x67 g: jungseong eu */
		[0x1102,0x0000],	/* 0x68 h: choseong nieun */
		[0x1106,0x0000],	/* 0x69 i: choseong mieum */
		[0x110B,0x0000],	/* 0x6A j: choseong ieung */
		...
		[0x11BA,0x11B6],	/* 0x71 q: jongseong sieus, jongseong lieul-hieuh */
		[0x1165,0x11B3],	/* 0x72 r: jungseong eo, jongseong lieul-sieus */ 
		[0x11AB,0x11AD],	/* 0x73 s: jongseong nieun, jongseong nieun-hieuh */
		[0x1162,0x1164],	/* 0x74 t: jungseong ae, jungseong yae */
		[0x1103,0x0000],	/* 0x75 u: choseong dieud */
		[0x1169,0x11B5],	/* 0x76 v: jungseong o, jongseong lieul-pieup */  
		[0x11AF,0x11B0],	/* 0x77 w: jongseong lieul, jongseong lieul-gieug */
		[0x11A8,0x11A9],	/* 0x78 x: jongseong gieug, jongseong ssanggieug */
		[0x1105,0x0000],	/* 0x79 y: choseong lieul */
	...
	K3_2015_layout = [
		...
		[0x0038,0x0000],	/* 0x4F O: 8 */
		[0x0039,0x0000],	/* 0x50 P: 9 */
		[0x11A9,0x11A9],	/* 0x51 Q: jongseong ssanggieug, jongseong ssanggieug */
	...
	K3_2015M_layout = [
		...
		[0x1162,0x0000],	/* 0x72 r: jungseong ae */
		[0x11AB,0x0000],	/* 0x73 s: jongseong nieun */
		[0x1165,0x1164],	/* 0x74 t: jungseong eo, jungseong yae */
		[0x1103,0x0000],	/* 0x75 u: choseong dieud */
		[0x1169,0x0000],	/* 0x76 v: jungseong o */
		[0x11AF,0x0000],	/* 0x77 w: jongseong lieul */
		[0x11A8,0x0000],	/* 0x78 x: jongseong gieug */
	...
	K3_2015P_layout = [
		...
		[0x11BC,0x11B9],	/* 0x61 a: jongseong ieung, jongseong bieub-sieus */
		[0x116E,0x0000],	/* 0x62 b: jungseong u */
		[0x1166,0x11B4],	/* 0x63 c: jungseong e, jongseong lieul-tieut */  
		[0x1175,0x11B2],	/* 0x64 d: jungseong I, jongseong lieul-bieub */  
		[0x1167,0x11AC],	/* 0x65 e: jungseong yeo, jongseong nieun-jieuj */
		[0x1161,0x11B5],	/* 0x66 f: jungseong a, jongseong lieul-pieup */  
		[0x1173,0x0000],	/* 0x67 g: jungseong eu */
		[0x1102,0x0000],	/* 0x68 h: choseong nieun */
		[0x1106,0x0000],	/* 0x69 i: choseong mieum */
		[0x110B,0x0000],	/* 0x6A j: choseong ieung */
		...
		[0x1162,0x1164],	/* 0x74 t: jungseong ae, jungseong yae */
		[0x1103,0x0000],	/* 0x75 u: choseong dieud */
		[0x1169,0x11AA],	/* 0x76 v: jungseong o, jongseong gieug-sieus */
		[0x11AF,0x11B0],	/* 0x77 w: jongseong lieul, jongseong lieul-gieug */  
		[0x11A8,0x11A9],	/* 0x78 x: jongseong gieug, jongseong ssanggieug */  
		[0x1105,0x0000],	/* 0x79 y: choseong lieul */
		[0x11B7,0x11B1],	/* 0x7A z: jongseong mieum, jongseong lieul-mieum */
	...
	K3_P3_layout = [
		...
		[0x1163,0x0000],	/* 0x36 6: jungseong ya */
		[0x1168,0x0000],	/* 0x37 7: jungseong ye */
		[0x1173,0x0000],	/* 0x38 8: jungseong eu */
		[0x116E,0x0000],	/* 0x39 9: jungseong u */
	...
	K3_D1_layout = [
		...
		[0x11A9,0x0000],	/* 0x58 X: jongseong ssanggieug */
		...
		[0x11BA,0x0000],	/* 0x71 q: jongseong sieus */
		[0x1162,0x1164],	/* 0x72 r: jungseong ae, jungseong yae */
		[0x11AB,0x0000],	/* 0x73 s: jongseong nieun */
		[0x1165,0x0000],	/* 0x74 t: jungseong eo  */
		[0x1103,0x0000],	/* 0x75 u: choseong dieud */
		[0x1169,0x0000],	/* 0x76 v: jungseong o */
	...
	K3_D1_y_layout = [
		...
		0x0024,	/* 0x24 dollar */
		0x0025,	/* 0x25 percent */
		0x005B,	/* 0x26 ampersand */
		0x1110,	/* 0x27 apostrophe: choseong tieuh */
		0x0028,	/* 0x28 parenleft */
		0x0029,	/* 0x29 parenright */
		0x005D,	/* 0x2A asterisk */
		0x002B,	/* 0x2B plus */
		0x002C,	/* 0x2C comma */
		0x002D,	/* 0x2D minus */
		0x002E,	/* 0x2E period */
		...
		0x1140,	/* 0x4E N: choseong yeolin-sieus */
		0x1155,	/* 0x4F O: choseong dwits-chieuch */
		0x2026,	/* 0x50 P: horizontal epllipsis */
		0x11EB,	/* 0x51 Q: jongseong yeolin-sieus */
		0x1164,	/* 0x52 R: jungseong yae */
		0x11F9,	/* 0x53 S: jongseong yeolin-hieuh */
		0x119E,	/* 0x54 T: jungseong alae-a */
		0x302E,	/* 0x55 U: hangeul single dot tone mark */
		...
		0x300C,	/* 0x5B bracketleft */
		0x3002,	/* 0x5C backslash */
		0x300D,	/* 0x5D bracketright */
		0x005E,	/* 0x5E asciicircum */
		0x005F,	/* 0x5F underscore */
		0x00B7,	/* 0x60 quoteleft: middle dot */
		0x11BC,	/* 0x61 a: jongseong ieung */
		...
		0x1105,	/* 0x79 y: choseong lieul */
		0x11B7,	/* 0x7A z: jongseong mieum */
		0x300E,	/* 0x7B braceleft */
		0x3001,	/* 0x7C bar */
		0x300F,	/* 0x7D braceright */
		0x203B	/* 0x7E asciitilde */
	];
	...
	K3_18Na_layout = [
		...
		[0x1101,0x0000], /* 0x52 R:            choseong ssanggieug */
		[0x1102,0x0000], /* 0x53 S:            choseong nieun */
		[0x110A,0x0000], /* 0x54 T:            choseong ssangsios */
		[0x11BA,0x0000], /* 0x55 U:            jongseong sieus */
		[0x1111,0x0000], /* 0x56 V:            choseong pieup */
		[0x110D,0x0000], /* 0x57 W:            choseong ssangjieuj */
	...
	K3_Sin3_2003_layout = [
		...
		[0x11BB,0x0000],	/* 0x66 f: jongseong ssangsieus */
	...
	K3_Sin3_2012_layout = [
		...
		[0x005B,0x119E],	/* 0x5B left bracket, jungseong alae-a */
		[0x005C,0x0000],	/* 0x5C backslash */
		...
		[0x11BB,0x11AC],	/* 0x64 d: jongseong ssangsieus, jongseong nieun-jieuj */
		[0x11B8,0x11B2],	/* 0x65 e: jongseong bieub, jongseong lieul-bieub */
	...
	K3_Sin3_P_layout = [
		...
		[0x116E,0x0000],	/* 0x4F O: jungseong u */
		[0x119E,0x0000],	/* 0x50 P: jungseong alae-a */
		[0x1164,0x11B3],	/* 0x51 Q: jungseong yae, jongseong lieul-sieus */
		[0x1165,0x11B4],	/* 0x52 R: jungseong eo, jongseong lieul-tieut */
		[0x1168,0x11AD],	/* 0x53 S: jungseong ye, jongseong nieun-hieuh */
		[0x1162,0x0000],	/* 0x54 T: jungseong ae */
	...
	K3_Sin3_Gongdong_layout = [
		...
		[0x11BB,0x0000],	/* 0x64 d: jongseong ssangsieus */
	...
	K3_Sin3_Cham_f_layout = [
		...
		[0x0025,0x0000],	/* 0x25 percent */
		[0x0026,0x0000],	/* 0x26 ampersand */
		[0x0027,0x001B],	/* 0x27 apostrophe: apostrophe, escape */
		[0x0028,0x0000],	/* 0x28 parenleft */
		[0x0029,0x0000],	/* 0x29 parenright */
		[0x002A,0x0000],	/* 0x2A asterisk */
		[0x002B,0x0000],	/* 0x2B plus */
		...
		[0x1111,0x1169],	/* 0x2F slash: choseong pieup, jungseong o */
		[0x0030,0x0000],	/* 0x30 0 */
		[0x0031,0x0000],	/* 0x31 1 */
		[0x0032,0x0000],	/* 0x32 2 */
		[0x0033,0x0000],	/* 0x33 3*/
		...
		[0x2190,0x0000],	/* 0x45 E: leftwards arrow ← */
		...
		[0x300E,0x0000],	/* 0x49 I: left white corner bracket 『 */
		[0x00B7,0x0000],	/* 0x4A J: middle dot */
		[0x2026,0x0000],	/* 0x4B K: semicolon: horizontal epllipsis */
		[0x002F,0x0000],	/* 0x4C L: slash */
		[0x00B0,0x0000],	/* 0x4D M: degree sign ° */
		[0x2606,0x0000],	/* 0x4E N: star ☆ */
		[0x300F,0x0000],	/* 0x4F O: right white corner bracket */
		[0x003B,0x0000],	/* 0x50 P: semicolon */
		[0x261E,0x0000],	/* 0x51 Q:  */
		[0x2192,0x0000],	/* 0x52 R:  */
		[0x2019,0x0000],	/* 0x53 S:  */
		[0x25A1,0x0000],	/* 0x54 T:  */
		[0x300D,0x0000],	/* 0x55 U:  */
		[0x300B,0x0000],	/* 0x56 V:  */
		[0x203B,0x0000],	/* 0x57 W: reference mark */
		[0x3009,0x0000],	/* 0x58 X:  */
		[0x300C,0x0000],	/* 0x59 Y:  */
		[0x3008,0x0000],	/* 0x5A Z:  */
		[0x005B,0x119E],	/* 0x5B bracketleft, alae-a */
		[0x005C,0x0000],	/* 0x5C backslash */
		[0x005D,0x11A2],	/* 0x5D bracketright, ssangalae-a */
		[0x005E,0x0000],	/* 0x5E asciicircum */
		[0x005F,0x0000],	/* 0x5F underscore */
		[0x0060,0x0000],	/* 0x60 quoteleft */
		...
		[0x1105,0x0000],	/* 0x6E n: choseong lieul */
		[0x110C,0x1169],	/* 0x6F o: choseong jieuj, jungseong o */
		[0x1110,0x0000],	/* 0x70 p: choseong tieut */
		[0x1172,0x11BB],	/* 0x71 q: jungseong yu, jongseong ssangsieus */
	...
	K3_2012y_extended_hangeul_layout = [
		...
		[[0xD7BF,0x0000], [0x119E,0x11A2]], /* 0x65 e: i+yeo, alae-a, ssangalae-a */
...
K3_Anmatae_layout = [
		...
		0x002F, /* 0x49 I: slash */
		0x119E, /* 0x4A J: jungseong alae-a */
	...
	K3_Semoe_2014_layout = [
		...
		0x119E, /* 0x36 6: jungseong alae-a */
		0x11A2, /* 0x37 7: jungseong ssangalae-a */
		0x0038, /* 0x38 8: 8 */
		0x0039, /* 0x39 9: 9 */
		0x0034, /* 0x3A colon: 4 */
...
function input_additional_combination_table_info() {
	...
	K3_D1_combination_table = hangeul_combination_table_default.slice(0);
	K3_D1_additional_combination_table = [
		...
		[0x11001109,0x110A], /* choseong gieug + sieus = ssangsieus */
		[0x11091100,0x110A], /* choseong sieus + gieug = ssangsieus */
	...
	K3_D1_y_combination_table.unshift(
		[0x11651165,0x119E], /* jungseong eo + eo = alae-a */
		[0x11741165,0x11A2], /* jungseong eui + eo = ssangalae-a */
	...
	K3_Semoe_2014_combination_table = [
		...
		{phonemes: [0x1175,0x119E], char: 0x11A1}, /* jungseong i   + alae-a = alae-ae */
