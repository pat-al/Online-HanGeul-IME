...
additional_layouts.push({KE: 'Ko', type_name: '3-P2', full_name: '3-P2 (연구 설계안)', layout: K3_P2_layout, sublayout: K3_P2_sublayout, extended_sign_layout: K3_2012y_extended_sign_layout, link: 'http://pat.im/1128'});
additional_layouts.push({KE: 'Ko', type_name: '3-P3', full_name: '3-P3 (연구 설계안)', layout: K3_P3_layout, sublayout: K3_P3_sublayout, extended_sign_layout: K3_P3_extended_sign_layout, link: 'http://pat.im/1128'});
...
function additional_keyboard_layout_table_info() {
	...
	K3_2012y_extended_sign_layout = [ // 3-2012 옛한글, 3-2014, 3-2015P 자판의 기호 확장 배열
		[[0x2921,0x0000,0x0000], [0x0000,0x0000,0x0000]], /* 0x21 exclam */
		[[0x266A,0x266C,0x0000], [0x0000,0x0000,0x0000]], /* 0x22 quotedbl */
		[[0x0000,0x0000,0x0000], [0x0000,0x0000,0x0000]], /* 0x23 numbersign */
		[[0x0000,0x0000,0x0000], [0xFE35,0x0000,0x0000]], /* 0x24 dollar */
	...
	K3_P3_extended_sign_layout = [
		...
		[[0x0000,0x0000,0x0000], [0x0000,0x0000,0x0000]], /* 0x38 8 */
		[[0x0000,0x0000,0x0000], [0x0000,0x0000,0x0000]], /* 0x39 9 */
		[[0x266A,0x266C,0x0000], [0x0000,0x0000,0x0000]], /* 0x3A colon [0x2084,0x0000,0x0000]*/
		...
		[[0x2018,0x201C,0x0000], [0x0000,0x0000,0x0000]], /* 0x48 H [0x2080,0x0000,0x0000]*/ 
