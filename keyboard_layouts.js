...
keyboard_layouts.push({KE: 'Ko', type_name: 'Sin3-P2-y', full_name: '신세벌식 P2 옛한글 확장', layout: K3_Sin3_P2_y_layout, capslock_layout: K3_Sin3_P2_y_capslock_layout, extended_hangeul_layout: K3_Sin3_P2_extended_hangeul_layout, extended_sign_layout: K3_Sin3_extended_sign_layout, capslock_extended_sign_layout: null, hangeul_combination_table: K3_Sin3_P2_yeshangeul_combination_table, link: 'https://pat.im/1136#2-5'});
...
function input_keyboard_layout_info() {
	...
	K2_KSX5002_y_layout = [
		...
		0x119E, /* 0x4B K: jungseong alae-a */
		0x1175, /* 0x4C L: jungseong i */
		0x1173, /* 0x4D M: jungseong eu */
	...
	K3_93y_layout = [
		...
		0x11BF,	/* 0x45 E: jongseong kieuk */
		0x11A9,	/* 0x46 F: jongseong ssang_gieug */
		0x119E,	/* 0x47 G: jungseong alae-a */
		0x0027,	/* 0x48 H: apostrophe */
	...
	K3_Sin3_P2_layout = [
		...
		[0x119E,0x11B1],	/* 0x5A Z: jungseong alae-a, jongseong lieul-mieum */
		...
		[0x11BC,0x11AA],	/* 0x61 a: jongseong ieung, jongseong gieug-sieus */
		[0x11BE,0x0000],	/* 0x62 b: jongseong chieuch */
		[0x11A8,0x11A9],	/* 0x63 c: jongseong gieug, jongseong ssang_gieug */
		[0x11C2,0x11B6],	/* 0x64 d: jongseong hieuh, jongseong lieul-hieuh */
		[0x11B8,0x11B2],	/* 0x65 e: jongseong bieub, jongseong lieul-bieub */
		[0x11C1,0x11B5],	/* 0x66 f: jongseong pieup, jongseong lieul-pieup */
		...
		[0x1111,0x119E],	/* 0x70 p: choseong pieup, jungseong alae-a */
		...
		[0x11BD,0x11AC],	/* 0x76 v: jongseong jieuj, jongseong nieun-jieuj */
		[0x11AF,0x11B0],	/* 0x77 w: jongseong lieul, jongseong lieul-gieug */
		[0x11BB,0x11B9],	/* 0x78 x: jongseong ssang_sieus, jongseong bieub-sieus */
	...
	K3_Sin3_P2_y_layout[44][0] = -1; /* 0x4D M: yeshangeul extension key */
	...
	K3_Sin3_P2_extended_hangeul_layout = [
		[0x0000], /* 0x21 exclam */
		...
		[0x0000], /* 0x2B plus */
		[0x113C], /* 0x2C comma: choseong ap_sieus */
		[0x0000], /* 0x2D minus */
		[0x113E], /* 0x2E period: choseong dwis_sieus */
		[0x0000], /* 0x2F slash */
		[0x0000], /* 0x30 0 */
		[0x0000], /* 0x31 1 */
		[0x0000], /* 0x32 2 */
		...
		[0x113D], /* 0x3C less: choseong ssang_ap_sieus */
		[0x0000], /* 0x3D equal */
		[0x113F], /* 0x3E greater: choseong ssang_dwis_sieus */
		...
		[0x0000], /* 0x49 I */
		[0x0000], /* 0x4A J */
		[0x114F], /* 0x4B K: choseong ssang_ap_jieuj */
		[0x1151], /* 0x4C L: choseong ssang_dwis_jieuj */
		...
		[0x11F0], /* 0x61 a: jongseong yes_ieung */
		[0x0000], /* 0x62 b */
		[0x0000], /* 0x63 c */
		[0x11F9], /* 0x64 d: jongseong yeolin_hieuh */
		[0x0000], /* 0x65 e */
		[0x0000], /* 0x66 f */
		[0x0000], /* 0x67 g */
		[0x0000], /* 0x68 h */
		[0x1154], /* 0x69 i: choseong ap_chieuch */
		[0x114C], /* 0x6A j: choseong yes_ieung */
		[0x114E], /* 0x6B k: choseong ap_jieuj */
		[0x1150], /* 0x6C l: choseong dwis_jieuj */
		[0x1159], /* 0x6D m: choseong yeolin_hieuh */
		[0x1140], /* 0x6E n: choseong yeolin_sieus */
		[0x1155], /* 0x6F o: choseong dwis_chieuch */
		[0x0000], /* 0x70 p */
		[0x11EB], /* 0x71 q: jongseong yeolin_sieus */
		[0x0000], /* 0x72 r */
		[0x0000], /* 0x73 s */
		[0x0000], /* 0x74 t */
		[0x0000], /* 0x75 u */
...
function input_combination_table_info() {
	...
	hangeul_combination_table_default = [
		...
		[0x119E119E,0x11A2], /* jungseong alae-a + alae-a = ssang_alae-a */
	...
	hangeul_combination_table_full = [
		...
		[0x11611161,0x119E], /* jungseong a + a  = alae-a */
		...
		[0x1175119E,0x119D], /* jungseong i + alae-a = i-alae-a */
		[0x11821175,0xD7B1], /* jungseong o-o + i  = o-o-i */
		[0x11991169,0xD7BD], /* jungseong i-ya + o = i-ya-o */
		[0x119a1175,0xD7C1], /* jungseong i-o + i  = i-o-i */
		[0x119E1161,0xD7C5], /* jungseong alae-a + a = alae-a-a */
		[0x119E1165,0x119F], /* jungseong alae-a + eo = alae-a-eo */
		[0x119E1166,0xD7C6], /* jungseong alae-a + e = alae-a-e */
		[0x119E116E,0x11A0], /* jungseong alae-a + u = alae-a-u */
		[0x119E1175,0x11A1], /* jungseong alae-a + i = alae-a-i */
		[0x119E119E,0x11A2], /* jungseong alae-a + alae-a = ssang_alae-a */
		...
		[0xD7C51161,0x11A2], /* jungseong alae-a-a + a = ssang_alae-a */
	...
	K2_hangeul_combination_table.unshift(
		[0x11611161,0x119E], /* jungseong a + a = alae-a */
		[0x11751175,0x11A2] /* jungseong i + i = ssang_alae-a */
	);	
...
//		[0x11751173,0x1174], /* jungseong i  ㅣ + eu ㅡ = eui ㅢ */
	...
	moachigi_combination_table_default = [
		...
		{phonemes: [0x119E,0x1175], char: 0x11A1}, /* jungseong alae-a + i = alae-a-i */
		{phonemes: [0x119E,0x119E], char: 0x11A2}, /* jungseong alae-a + alae-a = ssang_alae-a */
